...
<head>
    ...
    <title>Bouki shopping | Paiement</title>
    <!-- Slick Slider -->
...
<body>
    ...
    <div class="osahan-success bg-success vh-100">
        <div class="p-5 text-center">
            ...
            <h1 class="text-white fw-bold">Osahan, Your order has been successful 🎉</h1>
            <p class="text-white">Check your order status in <a href="complete_order.html" class="fw-bold text-decoration-none text-white">My Order</a> about next steps information.</p>
        </div>
    </div>
    <!-- continue -->
...
</html><?php /**PATH C:\xampp\htdocs\bouki\resources\views/mtn.blade.php ENDPATH**/ ?>