...
<body class="fixed-bottom-padding">
                     ...
                     <div class="row">
                        <?php for($j = $i; $j < $i + 3 && $j < $count; $j++): ?> <div class="col-4">
                           <div class="text-center mb-3">
                              <a href="<?php echo e(route ('catepage.show', ['category' => $categories[$j]->id])); ?>">
   ...
   <div class="title d-flex align-items-center p-3">
      ...
      <a class="ms-auto text-success" href="#"><?php echo e($articleCount); ?> Articles et plus</a>
   </div>
   <!-- osahan recommend -->
            ...
            <div class="text-dark text-decoration-none">
               <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                  <div class="recommend-slider rounded pt-2">
                     ...
                     <?php if($loop->index < 8): ?> <div class="osahan-slider-item m-2 rounded">
   ...
   <div class="pick_today px-3">
       <h6 class="m-0">Recommander pour vous</h6>
       <a class="ms-auto text-success" href="<?php echo e(route("autres.plus")); ?>">Voir plus d'articles </a>
      <div class="row">
         <?php $__currentLoopData = $articles->where('quantity', '!=', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <?php if($loop->index < 4): ?> <div class="col-6 pe-2 mb-3">
            <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
               <div class="list-card-image">
                  <a href="<?php echo e(route ('details', $article->id)); ?>" class="text-dark">
                      <?php if(Carbon::parse($article->created_at)->gt(Carbon::now()->subDays(5))): ?>
                     ...
                     <div class="p-3">
                        ...
                        <h6><?php echo e($article->numero); ?></h6>
                        <div class="d-flex align-items-center">
      ...
      <div class="row">
         <div class="col-12 mb-3">
            <div  class="text-dark text-decoration-none">
               <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                  <div class="recommend-slider rounded pt-2">
                     <?php $__currentLoopData = $articles->where('is_promo', '!=', 0)->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   ...
   <div class="title d-flex align-items-center mb-3 mt-3 px-3">
       ...
       <a class="ms-auto text-success" href="<?php echo e(route('autres.plus')); ?>">Plus d'articles</a>
   </div>
   <!-- pick today -->
   <div class="pick_today px-3">
       <div class="row">
           <?php $__currentLoopData = $articles->where('is_promo', '!=', 0)->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <?php if($loop->index < 8): ?> <div class="col-6 pe-2 mb-3">
                   <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                       <div class="list-card-image">
...
<?php /**PATH C:\xampp\htdocs\bouki\resources\views/welcome.blade.php ENDPATH**/ ?>