...
<div class="col-lg-12 d-flex align-items-stretch">
    <div class="card w-100">
        <div class="card-body p-4">
            ...
            <a href="<?php echo e(route('ajout.article')); ?>" class="btn btn-primary"> <i class="ti ti-box"></i> Ajouter des articles </a>
            <br><br>
                ...
                <table id="example" class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" class="checkbox-column" value="<?php echo e($article->id); ?>">
                            </td>
                            <td class="border-bottom-0">
                                <!-- <img src="<?php echo e(asset('storage/' . $article->image)); ?>" alt="Article Image" width="75"> -->
                                <img src="<?php echo e($article->image); ?>" alt="Article Image" width="75" class="clickable-image" data-bs-toggle="modal" data-bs-target="#imageModal">
                            </td>
                            <td class="border-bottom-0">
                                <p class="mb-0 fw-normal"><?php echo e($article->titre); ?></p>
                            </td>
                            <td class="border-bottom-0">
                            ...
                            <td class="border-bottom-0">
                                <p class="mb-0 fw-normal">
                                    <b><?php echo e($article->subcategorie->categorie->categoriename); ?></b>
                                <p><small><span class="ti ti-arrow-right"></span> <?php echo e($article->subcategorie->subcategoryname); ?></small></p>
                                </p>
                            </td>
                            <td class="border-bottom-0">
                            ...
                            <td class="border-bottom-0">
                                <div class="flex-right" style="display: flex; justify-content: flex-left;">
                                    ...
                                    <a href="<?php echo e(route('details.article', $article->id)); ?>" class="btn btn-success btn-sm" style="margin-right: 10px;"><i class="ti ti-eye"></i> </a>
                                    <a href="<?php echo e(route('articles.edit', $article->id)); ?>" class="btn btn-primary btn-sm" style="margin-right: 10px;"><i class="ti ti-edit"></i> </a>
    ...
    $(document).ready(function() {
        ...
        $('#update-status-btn').on('click', function() {
            ...
            if (selectedIds.length > 0) {
                ...
                $.ajax({
                    url: '<?php echo e(route("updateStatus")); ?>', // Utilisez la véritable route de mise à jour du statut
                    method: 'POST',
                    data: {
...
<?php echo $__env->make('layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Myshop\resources\views/articles/index.blade.php ENDPATH**/ ?>