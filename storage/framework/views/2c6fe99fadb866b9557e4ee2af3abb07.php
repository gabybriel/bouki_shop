    ...
    <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php endif; ?>
                <form method="post" action="<?php echo e(route('categories.update', $categorie->id)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Myshop\resources\views/categories/edit.blade.php ENDPATH**/ ?>