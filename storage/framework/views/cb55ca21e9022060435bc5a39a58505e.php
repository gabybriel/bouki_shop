...
<?php endif; ?>
   ...
   <div class="osahan-fotter fixed-bottom">
      <a href="<?php echo e(route('register')); ?>" class="btn btn-block btn-lg bg-white">Vous n'avez pas de compte ? S'inscrire</a>
   </div>
...
</html><?php /**PATH C:\xampp\htdocs\Myshop\resources\views/auth-login.blade.php ENDPATH**/ ?>