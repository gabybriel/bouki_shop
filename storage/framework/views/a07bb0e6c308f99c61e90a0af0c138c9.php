           ...
           <div class="row">
                       ...
                       <div class="accordion" id="accordionPanelsStayOpenExample">
                           <div class="accordion-item">
                               ...
                               <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
                                   <div class="accordion-body">
                                       <form method="GET" action="<?php echo e(route('catepage.show')); ?>">
                                           <ul>
                                               <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <li class="list-unstyled">
                                                       <label>
                                                           <input type="radio" name="category_id" value="<?php echo e($category->id); ?>" <?php echo e($category->id == $categoryId ? 'checked' : ''); ?>>
                           ...
                           <div class="accordion-item">
                               ...
                               <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo">
                                   <div class="accordion-body">
                                       <form method="GET" action="<?php echo e(route('catepage.show', $category->id)); ?>">
                                           <ul>
                                               <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <li class="list-unstyled">
                                                       <label>
                                                           <input type="radio" name="subcategory_id" value="<?php echo e($subcategory->id); ?>"
                                                               <?php echo e($subcategory->id == $subCategoryId ? 'checked' : ''); ?>>
               ...
               <div class="col-lg-9">
                   <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
                       <strong class="d-block py-2"><?php echo e($articleCount); ?> articles trouvés </strong>
                   </header>
                   <div class="row">
...
<?php /**PATH C:\xampp\htdocs\bouki\resources\views/categoriepage.blade.php ENDPATH**/ ?>