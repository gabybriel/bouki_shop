...
<?php endif; ?>
    ...
    <div class="osahan-fotter fixed-bottom">
        <a href="<?php echo e(route('authlogin')); ?>" class="btn btn-block btn-lg bg-white"> Vous avez déjà un compte? Connectez-vous ici</a>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\Myshop\resources\views/auth/register.blade.php ENDPATH**/ ?>