<?php $__env->startSection('admin-content'); ?>
    ...
    <form action="<?php echo e(route('whatsapp.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="py-4 my-2">
            <div class="row ">
...
<?php echo $__env->make('layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bouki\resources\views/whatsapp/create.blade.php ENDPATH**/ ?>