...
<body class="fixed-bottom-padding">
    ...
    <div class="osahan-account">
        ...
        <div class="p-4 profile text-center border-bottom">
            ...
            <a href="<?php echo e(route ('profile.edit', Auth::user()->id)); ?>" class="btn btn-success btn-sm"><i class="icofont-pencil-alt-5"></i> Editer le profil</a>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\bouki\resources\views/dashboard.blade.php ENDPATH**/ ?>