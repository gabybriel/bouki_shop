            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav"><br><br>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route ('marchand.index')); ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-users"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route ('finances.index')); ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-users"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route ('whatsapp.index')); ?>" aria-expanded="false">
                                <span>
...
<?php /**PATH C:\xampp\htdocs\bouki\resources\views/layouts/admin-layout.blade.php ENDPATH**/ ?>