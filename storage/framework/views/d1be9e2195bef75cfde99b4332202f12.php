    ...
    <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php endif; ?>
                <form method="post" action="<?php echo e(route('slider-config.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Myshop\resources\views/sliders/create.blade.php ENDPATH**/ ?>