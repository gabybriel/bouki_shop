            ...
            <div class="card-body">
                ...
                <form method="post" action="<?php echo e(route('articles.store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <label for="marchand" class="form-label">Marchand</label>
...
<?php echo $__env->make('layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Myshop\resources\views/articles/create.blade.php ENDPATH**/ ?>