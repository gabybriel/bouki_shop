                ...
                <div class="brand-logo d-flex align-items-center justify-content-between" style="background-color: #898989">
                    <a href="/" class="text-nowrap logo-img">
                        <b class="p-5" style="color: #fff;">
                            ...
                            Administrateur
                            <?php elseif(Auth::user()->is_vendor): ?>
                            Marchand
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav"><br><br>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('vendor-dashboard')); ?>" aria-expanded="false" style="background-color: #898989;color:#fff;">
                                <span>
                        ...
                        <br><br>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route ('mes-articles')); ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-box"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route ('vendors.index')); ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('portefeuille.index')); ?>" aria-expanded="false">
                                <span>
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                    <div class="message-body">
                                        ...
                                        <form method="POST" action="<?php echo e(route('logout')); ?>" x-data>
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="btn btn-outline-primary mx-3 mt-2 d-block" href="<?php echo e(route('logout')); ?>" @click.prevent="$root.submit();" style="background-color: #898989;color:#fff;">
                                                Deconnexion</button>
                                        </form>
                                    </div>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\bouki\resources\views/layouts/vendor-layout.blade.php ENDPATH**/ ?>