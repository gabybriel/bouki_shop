    ...
    <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ route('slider-config.update', $sliders->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" id="number" name="position" class="form-control" value="{{ $sliders->position }}">
