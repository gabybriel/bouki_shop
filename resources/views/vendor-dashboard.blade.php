                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card views-card text-center mt-3 mb-3">
                                    ...
                                    <h3 class="views-count mt-3"> <i class="ti ti-chart-bar views-icon"></i> {{ $vuesDuJour }}</h3>
                                    <p class="lead">Vues sur vos articles <br> aujourd'hui</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card views-card text-center mt-3 mb-3">
                                    <h3 class="views-count mt-3"><i class="ti ti-chart-bar views-icon"></i> {{ $vuesDuMois }}</h3>
                 ...
                 <div class="card">
                        <div class="card-body">
                            <div class="row alig n-items-start">
                                <div class="col-12">
                                    <h4 class="card-title mb-9 fw-semibold"> <i class="ti ti-wallet views-icon"></i> Portefeuille </h4>
                                    <h4 class="fw-semibold mb-3">{{$totalSum}} FCFA</h4>
                                    <h6><a href="{{route('vendors.create')}}">Effectuer un retrait <i class="ti ti-arrow-right"></i></a></h6>
