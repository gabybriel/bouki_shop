...
<body>
  ...
  -->
    ...
    <header>
        ...
        <div class="header-main" style="background-color: yellow; background-image: url('./asset/images/barner.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">

            <div class="container">

                <a href="/" class="header-logo">
                    <img src="./asset/images/logo/logo.png" alt="Anon's logo" width="145">
                </a>
    ...
    <section class="h-100 h-custom">
        <div class="container py-4 ">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col">
                    <h3 style="text-align: center;"> PAIEMENT </h3><br>
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="alert alert-success">
                                        {{ session('success') }} <a href="/" class="btn btn-success btn-sm"> <span class="fa fa-shopping-cart-add"></span> Ajoutez d'autres articles à votre panier </a>
                                    </div>
                                    Vous avez 0 articles dans votre panier Vous avez 0 articles dans votre panierVous avez 0 articles dans votre panier
                                    @endif
