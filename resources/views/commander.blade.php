    ...
    <div class="osahan-payment">
        <div class="p-3 border-bottom">
            <div class="d-flex align-items-center">
                <a class="fw-bold text-success text-decoration-none" href="{{ route('cart.index') }}">
        ...
        <div class="hiden" role="group" aria-label="Basic radio toggle button group" style="display: none">
            ...
            @foreach (Cart::content() as $product)
                ...
                <div class="hiden">
                    <div class="d-flex align-items-center p-3">
                        <a href="product_details.html"><img src="{{ $product->model->image }}" class="img-fluid"></a>
                        <a href="product_details.html" class="ms-3 text-dark text-decoration-none w-100">
                            <h5 class="mb-1">{{ $product->model->taille }}</h5>
                            <p class="text-muted mb-2"><span class="text-success me-1"> {{ number_format(floatval($product->price), 0, ',', ' ') }} FCFA</span></p>
                            <div class="d-flex align-items-center">
        ...
        <form action="{{ route('commande.store') }}" method="POST">
                            ...
                            <div class="osahan-card-body p-3 border-top">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="btn-group" data-toggle="buttons">
                                        <label class="btn btn">
                                            ...
                                            <img src="{{ asset('./asset/images/mtn-logo.jpg') }}" alt="Option 1" class="img-fluid" width="100">
                                        </label>

                                        <label class="btn btn">
                                            <input type="radio" id="modePaiement" name="modepaiement" autocomplete="off" value="AIRTEL">
                                            <img src="{{ asset('./asset/images/airtel-logo.jpg') }}" alt="Option 2" class="img-fluid" width="100">
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="d-flex justify-content-between mb-3">
                                        ...
                                        <p class="mb-2" id="totalAmount"><b>{{ Cart::subtotal() }} FCFA</b></p>
                                    </div>
            ...
            @foreach (Cart::content() as $product)
            <!-- ... existing code ... -->
            <input type="hidden" name="article_ids[]" value="{{ $product->id }}">
            @endforeach
