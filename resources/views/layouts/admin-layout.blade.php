                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav"><br><br>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('admin-dashboard')}}" aria-expanded="false" style="background-color: #f02eb5;color:#fff;">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route ('sous-categories.index') }}" aria-expanded="false">
                                <span>
                                    <i class="ti ti-cards"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route ('marchand.index') }}" aria-expanded="false">
                                <span>
                                    <i class="ti ti-users"></i>
                                </span>
                                <span class="hide-menu">Marchands</span>
                            </a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route ('finances.index') }}" aria-expanded="false">
                                <span>
                                    <i class="ti ti-users"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route ('whatsapp.index') }}" aria-expanded="false">
                                <span>
                                    <i class="ti ti-brand-whatsapp"></i>
                                </span>
                                <span class="hide-menu">Message WhatsApp</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route ('slider-config.index') }}" aria-expanded="false">
                                <span>
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                    <div class="message-body">
                                        ...
                                        <form method="POST" action="{{ route('logout') }}" x-data>
                                            @csrf
                                            <button type="submit" class="btn btn-outline-primary mx-3 mt-2 d-block" href="{{ route('logout') }}" @click.prevent="$root.submit();" style="background-color: #f02eb5;color:#fff;">
                                                Deconnexion</button>
                                        </form>
                                    </div>
                                </div>
