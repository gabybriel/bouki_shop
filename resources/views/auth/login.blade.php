...
<body class="fixed-bottom-padding">
   ...
   <div class="fixed-bottom fixed-bottom-auto px-4 pt-4 text-center d-grid gap-2">
      <a href="{{ route('register') }}" class="btn btn-success rounded btn-block btn-lg">
         Créer un compte
      </a>
      ...
      <a href="{{ route('authlogin') }}" class="text-white btn btn-sm btn-block text-decoration-none mb-2">Vous avez déjà un compte? <br> Connectez-vous ici</a>
   </div>
