...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('./asset/images/logo/favicon.ico') }}" type="image/x-icon">
    ...
    <section class="h-100 h-custom">
        <div class="container py-4 ">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col">
                    <h3 style="text-align: center;"> PAIEMENT AIRTEL </h3><br>
                    <div class="card">
                        <div class="card-body p-2">

                            <div class="row">
                                <div class="col-lg-12">
                                    <h5 class="mb-3"><a href="/" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Continuez vos achats</a></h5>
                                    <hr>
                                    @if (session('success'))
                                    <h5 class="alert alert-warning d-flex align-items-center justify-content-center">
                                        <img src="{{ asset('./asset/images/airtel-logo.jpg') }}" width="100">

                                        <h5 style="text-align: center;" class="alert alert-warning">Votre commande est en attente de paiement ...</h5>

                                        <h4 style="text-align: center;" class="alert alert-success"> {{ session('success') }}</h4>
                                    ...
                                    <div class="text-center">
                                        <a href="/" class="btn btn-success">Retour à la page d'accueil</a>
                                    </div>
    ...
    <footer>
        ...
        <div class="footer-category">
            ...
            <div class="container">
                ...
                <h2 class="footer-category-title" style="text-align: center;"><a href="{{ route('user.cgv')}}"> Conditions generales de vente </a></h2>
